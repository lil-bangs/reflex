      ...
      <script dangerouslySetInnerHTML={{__html: `
        ...
        function triggerGo() {
          ...
          requestAnimationFrame(() => {
            ...
            const btn = document.getElementById('mainBtn');
            btn.textContent = 'TAP!';
            btn.className = 'btn-primary go-btn';
            btn.disabled = false;
          });
        }
        ...
        function recordResult() {
          ...
          resTime.textContent = diff + 'ms';
          resTime.style.color = tier.color;
          resRank.textContent = tier.rank;
          resRank.style.color = tier.color;
          ...
          mainBtn.textContent = 'CAST MY SCORE';
          mainBtn.className = 'btn-primary';
          mainBtn.disabled = false;
          mainBtn.onclick = share;
          document.getElementById('retryBtn').style.display = 'block';
          if (diff < 250 && window.farcasterSDK) {
            setTimeout(() => window.farcasterSDK.actions.addMiniApp(), 900);
          }
        }
        function resetGame() {
          state = 'IDLE';
